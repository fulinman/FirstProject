    ...
    LightBox.prototype = {
        ...
        showMaskAndPopup:function (sourceSrc,currentId) {
            ...
            if(groupDataLength > 1){
                if(this.index === 0){
                    this.nextBtn.removeClass("ban")
                    this.prevBtn.addClass("ban")
                }else if(this.index === groupDataLength-1){
                    this.nextBtn.addClass("ban")
                    this.prevBtn.removeClass("ban")
                }else{
                    this.nextBtn.removeClass("ban")
                    this.prevBtn.removeClass("ban")
                }
        ...
        renderDOM:function(){
            var strDOM = '<div class="lightbox-pic-view">'+
                ...
                '<img class="lightbox-image" src="1374776_143210_1_lit.jpg">'+
